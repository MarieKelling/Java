public class StudentListingsDriver
{
			...
			public StudentListingsDriver()			//No-Parameter Constructor to initialize an UnsortedOptimizedArray object
			{
				next = 0 ;
				size = 100 ; 
				data = new StudentListings[size] ;						//permits the client to specify a max amount for the data set 
			}
